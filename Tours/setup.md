...
5. Press Ctrl-C in the first terminal console to terminate `geth`. Output generated by `geth` as it shuts down will look something like:
  ```
...
6. Press Ctrl-D in the JavaScript console to exit.
